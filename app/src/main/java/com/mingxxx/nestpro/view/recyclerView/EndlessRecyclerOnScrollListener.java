...
public class EndlessRecyclerOnScrollListener extends RecyclerView.OnScrollListener implements OnListLoadNextPageListener {
    ...
    public static final int TYPE_STAGGEREDGRIDLAYOUT = 1;
    public static final int TYPE_GRIDLAYOUT = 2;
    ...
    public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
        ...
        if (layoutManagerType == -1) {
            if (layoutManager instanceof LinearLayoutManager) {
                layoutManagerType = TYPE_LINEARLAYOUT;
            } else if (layoutManager instanceof GridLayoutManager) {
                layoutManagerType = TYPE_STAGGEREDGRIDLAYOUT;
            } else if (layoutManager instanceof StaggeredGridLayoutManager) {
                layoutManagerType = TYPE_GRIDLAYOUT;
            } else {
