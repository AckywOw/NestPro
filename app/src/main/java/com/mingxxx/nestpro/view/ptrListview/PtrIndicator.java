...
public class PtrIndicator {
    ...
    private static final float RESISTANCE_ACCELERATION = 1.22f;
    ...
    protected void processOnMove(float currentX, float currentY, float offsetX, float offsetY) {
        float temp = mResistance;
        if (mCurrentPos > mOffsetToRefresh) {
            temp = temp * mCurrentPos / mOffsetToRefresh * RESISTANCE_ACCELERATION;
        }
        setOffset(offsetX, offsetY / temp);
    }
